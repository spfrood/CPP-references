...
//Function Prototypes
Encrypt getNum(); //function to convert a 4 digit short into 4 separate 1-digit numbers
Encrypt runCryp(Encrypt); //function to encrypt the 4 digit number
Encrypt decrypt(Encrypt); //function to decrypt an encrypted structure
short conShrt(Encrypt); //function to convert a structure to a short
short swapVal(short); //function to return the original value of an encrypted digit
...
int main(int argc, char** argv) {
    ...
    //Output values
    cout<<"Original value:  "<<conShrt(digs)<<endl;
    cout<<"Encrypted value: "<<conShrt(cDigs)<<endl;
    cout<<"Decrypted value: "<<conShrt(dDigs)<<endl;
...
//function to decrypt digits
Encrypt decrypt(Encrypt a) {
    Encrypt tmp=a;
    short swap=0;
    ...
    //Decrypt structure
    tmp.dig1=swapVal(tmp.dig1);
    tmp.dig2=swapVal(tmp.dig2);
    tmp.dig3=swapVal(tmp.dig3);
    tmp.dig4=swapVal(tmp.dig4);
