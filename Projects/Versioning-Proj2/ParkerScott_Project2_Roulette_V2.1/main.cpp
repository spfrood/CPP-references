...
float sNumWin(float betAmnt, int pickNum, int spinNum){
    float winLoss;
    (pickNum==spinNum)?winLoss=betAmnt*35:winLoss=betAmnt*(-1);
    if (betAmnt>0){
...
float oddWin(float betAmnt, int spinNum){
    float winLoss;
    (spinNum%2!=0)?winLoss=betAmnt*1:winLoss=betAmnt*(-1);
    if (betAmnt>0){
...
float blckWin(float betAmnt, int spinNum){
    ...
    blckNum?winLoss=betAmnt*1:winLoss=betAmnt*(-1);
    if (betAmnt>0){
...
float redWin(float betAmnt, int spinNum){
    ...
    redNum?winLoss=betAmnt*1:winLoss=betAmnt*(-1);
    if (betAmnt>0){
...
float topHWin(float betAmnt, int spinNum){
    float winLoss;
    (spinNum>=1&&spinNum<=18)?winLoss=betAmnt*1:winLoss=betAmnt*(-1);
    if (betAmnt>0){
...
float botHWin(float betAmnt, int spinNum){
    float winLoss;
    (spinNum>=19&&spinNum<=36)?winLoss=betAmnt*1:winLoss=betAmnt*(-1);
    if (betAmnt>0){
...
float fstTWin(float betAmnt, int spinNum){
    float winLoss;
    (spinNum>=1&&spinNum<=12)?winLoss=betAmnt*1:winLoss=betAmnt*(-1);
    if (betAmnt>0){
...
float sndTWin(float betAmnt, int spinNum){
    float winLoss;
    (spinNum>=13&&spinNum<=24)?winLoss=betAmnt*1:winLoss=betAmnt*(-1);
    if (betAmnt>0){
...
float trdTWin(float betAmnt, int spinNum){
    float winLoss;
    (spinNum>=25&&spinNum<=36)?winLoss=betAmnt*1:winLoss=betAmnt*(-1);
    if (betAmnt>0){
