...
float sNumWin(float betAmnt, int pickNum, int spinNum){
    float winLoss;
    (pickNum==spinNum)?winLoss=betAmnt*35.0f:winLoss=betAmnt*(-1.0f);
    if (betAmnt>0){
...
float fstTWin(float betAmnt, int spinNum){
    float winLoss;
    (spinNum>=1&&spinNum<=12)?winLoss=betAmnt*1.0f:winLoss=betAmnt*(-1.0f);
    if (betAmnt>0){
...
float sndTWin(float betAmnt, int spinNum){
    float winLoss;
    (spinNum>=13&&spinNum<=24)?winLoss=betAmnt*1.0f:winLoss=betAmnt*(-1.0f);
    if (betAmnt>0){
...
float trdTWin(float betAmnt, int spinNum){
    float winLoss;
    (spinNum>=25&&spinNum<=36)?winLoss=betAmnt*1.0f:winLoss=betAmnt*(-1.0f);
    if (betAmnt>0){
